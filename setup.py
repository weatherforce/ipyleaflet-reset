...
class NPM(Command):
    ...
    targets = [
        os.path.join(here, 'ipyleaflet_reset', 'static', 'extension.js'),
        os.path.join(here, 'ipyleaflet_reset', 'static', 'index.js')
    ]
...
version_ns = {}
with open(os.path.join(here, 'ipyleaflet_reset', '_version.py')) as f:
    exec(f.read(), {}, version_ns)

setup_args = {
    'name': 'ipyleaflet_reset',
    'version': version_ns['__version__'],
    'description': 'a jupyter leaflet control to reset the map',
    'long_description': LONG_DESCRIPTION,
    'include_package_data': True,
    'data_files': [
        ('share/jupyter/nbextensions/ipyleaflet-reset', static_files),
        ('etc/jupyter/nbconfig/notebook.d', ['ipyleaflet-reset.json'])
    ],
    'install_requires': [
        'ipywidgets>=7.0.0',
    ],
    ...
    'url': 'https://github.com/weatherforce/ipyleaflet-reset',
    'keywords': [
        'ipython',
        'jupyter',
        'widgets',
